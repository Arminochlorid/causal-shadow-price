"""
coverage_n2000_sandwich.py
==========================

Coverage-Studie fuer Algorithmus 1 bei n=2000 mit 50 Replikationen,
diesmal mit IF-SE UND Sandwich-SE parallel.

Fuellt die fehlende Zelle in Tabelle 2 von v9. Vorher hatten wir bei
n=2000 nur die IF-SE gerechnet (Coverage 0.750).

Erwartung:
  - IF-Coverage ~0.75 (wie zuvor reproduziert)
  - Sandwich-Coverage nahe 0.95 (oder etwas hoeher wegen Finite-Sample-Bias)
  - Sandwich-Ratio nahe 1

Laufzeit auf Colab CPU: ca. 12-18 Min.
"""
...
def coverage_study(n, n_reps, mu_star, T=4_000, T0=500, K=5):
    ...
    print()
    print(f"Vergleich zu vorherigen n:")
    print(f"  n=2000  (dieser Lauf):           IF={cov_if_final:.3f}, Sand={cov_sand_final:.3f}")
    print(f"  n=5000  (frueherer Lauf):        IF=0.800, Sand=0.940")
    print(f"  n=10000 (frueherer Lauf):        IF=0.780, Sand=0.900")
...
if __name__ == "__main__":
    print("Coverage-Studie bei n=2000 mit Sandwich-SE (Vervollstaendigung von Tab. 2)\n")
    print("Schritt 1: Referenz mu* via Oracle bei n=200000 ...")
    mu_star = reference_mu_star()
    print(f"  mu* = {mu_star:.4f}\n")

    print("Schritt 2: Coverage-Studie bei n=2000 mit 50 Replikationen...")
    res = coverage_study(n=2_000, n_reps=50, mu_star=mu_star,
                          T=4_000, T0=500, K=5)
